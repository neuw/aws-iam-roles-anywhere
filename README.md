...
|----------------|-------------------------|---------------------------|------------|-------------|-----------------------------------------------------------------------------------------------------------------------------------------------|
| 0.7.1-SNAPSHOT | 8                       | 17                        | 2.40.4     | 3.5.1       | Support for JDK 8 for core and Starter is JDK 17, with jackson 2 - jackson 3 does not work with JDK 8                                         |
...
| 1.0.0          | 8                       | 17                        | 2.39.6     | 4.0.0       | Support for JDK 8 for core and Starter is JDK 17, along with JACKSON 3 support, use 0.7.x for JDK 8 support                                   |
|                |                         |                           |            |             |                                                                                                                                               |

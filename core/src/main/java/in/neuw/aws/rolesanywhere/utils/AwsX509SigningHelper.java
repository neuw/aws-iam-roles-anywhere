...
public class AwsX509SigningHelper {
    ...
    private static AwsRolesAnywhereSessionsResponse getAwsRolesAnywhereSessionsResponse(ObjectMapper jm, HttpExecuteResponse httpExecuteResponse) throws IOException {
